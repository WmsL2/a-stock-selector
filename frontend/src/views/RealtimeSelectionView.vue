...
<template>
  ...
  <section class="panel"><EmptyState title="实时选股引擎尚未实现" :description="`IntradayScore、RealTimeScore 与实时 Top100 核心筛选/排名策略已实现，但尚未接入实时选股 API/UI；实时扫描器的运行时编排仍未实现。${infrastructureStatus}`" /></section>
</template>
